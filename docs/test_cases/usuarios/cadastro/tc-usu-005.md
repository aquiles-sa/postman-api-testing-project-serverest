# TC-USU-005 - Cadastro de usuário com senha em branco

| Item                     | Valor                                                                              |
| ------------------------ | ---------------------------------------------------------------------------------- |
| **ID**                   | TC-USU-005                                                                         |
| **Condição Relacionada** | CND-USU-009                                                                        |
| **Prioridade**           | Alta                                                                               |
...
- A resposta deve ter como mensagem `password não pode ficar em branco`
